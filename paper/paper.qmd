...
#| tbl-cap: First 6 entries of Raw Dataset with varibles 'state','end_date','sample_size', 'canadidate_name','pct'
#| echo: false
#| warning: false
#| message: false

raw_data <- read_csv(here::here("data/01-raw_data/president_polls.csv"))
#Graph
head_raw_data <- head(raw_data,6)
# Note there is a type in Description within the original data set itself
knitr::kable(head_raw_data[, c(13,15,23,51,52)], format = "simple",col.names = c('State','End date','Sample Size', 'Canadidate Name','PCT'))
